export const resources = {
  en: {
    translation: {
      ...
      exploreSourceHint: 'Featured: top 100 from clawhub.ai · Search: more results via skills.sh · Type 2+ characters to search',
  ...
  zh: {
    translation: {
      ...
      exploreSource: '数据来自',
      exploreSourceHint: '精选推荐：来自 clawhub.ai 的 Top 100 · 在线搜索：更多结果来自 skills.sh · 输入 2 个字符开始搜索',
